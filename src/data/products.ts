...
export const productsData: Product[] = [
    {
        ...
        categories: null,
        category_id: 'spice-blends-uuid',
        spice_level: 'Medium',
        is_vegan: true,
        // FIX: Added missing 'is_sponsored' property to satisfy the Product type.
        is_sponsored: false,
        is_active: true,
        ...
        // FIX: Added missing 'benefits' property.
        ...
        meta_title: 'Authentic Bisibelebath Powder | Havikar',
        meta_description: 'Buy handcrafted Bisibelebath powder made with traditional Karnataka spice roasting techniques. 100% natural and preservative-free.',
        meta_keywords: 'bisibelebath powder, karnataka spices, traditional indian food',
        // FIX: Added missing 'video_url' property to satisfy the Product type.
        video_url: null,
    },
    {
        id: 'havishta-chips',
        ...
        meta_title: 'Havishta Banana Chips | Handcrafted in Coconut Oil',
        meta_description: 'Pure coconut oil banana chips made with premium Nendran bananas. No artificial colors or preservatives. Taste the purity of Havikar.',
        meta_keywords: 'banana chips, kerala chips, coconut oil snacks',
        // FIX: Added missing 'video_url' property to satisfy the Product type.
        video_url: null,
    },
    {
        ...
        meta_title: 'Traditional Antina Unde | Ayurvedic Energy Balls',
        meta_description: 'Nutrient-rich Antina Unde made with edible gum, dry fruits, and pure ghee. A traditional Karnataka postpartum snack loved by all.',
        meta_keywords: 'antina unde, gond laddu, dry fruit sweets, postpartum nutrition',
        // FIX: Added missing 'video_url' property to satisfy the Product type.
        video_url: null,
    }
];